  ...
  return (
    <div className="max-w-5xl mx-auto w-full">
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-bold text-gray-900 mb-3">AI Image Generator</h1>
        <p className="text-gray-500">Generate stunning images from text descriptions using AI.</p>
      </div>
            ...
            <div className="border border-gray-200 rounded-2xl bg-gray-50 flex flex-col items-center justify-center overflow-hidden aspect-square lg:aspect-auto lg:h-full relative">
              {resultImage ? (
                ...
                <div className="flex flex-col items-center text-gray-400">
                  ...
                  <p className="text-base font-medium">Dreaming up your image...</p>
                </div>
              ) : (
                <div className="flex flex-col items-center text-gray-400">
